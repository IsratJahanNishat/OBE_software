...
@Service
public class CO4ExcelDataServiceImpl implements CO4ExcelDataService{
	...
	public List<CO4> getExcelDataAsList() {
		...
		List<CO4> invList = createList(list, noOfColumns);
	...
	private List<CO4> createList(List<String> excelData, int noOfColumns) {

		ArrayList<CO4> invList1 = new ArrayList<CO4>();
	...
	@Override
	public int saveExcelData(List<CO4> invoices1) {
